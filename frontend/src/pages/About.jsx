...
const About = () => {
  return (
    <div>
        <section id="section2" className='min-h-screen w-full bg-[#121e28] lg:p-20 flex flex-col items-center  md:p-12 p-6 text-white '> 
        <motion.h1 
        initial={{
          y:200,
          opacity:0
        ...
        className="text-center font-extralight">I'm Dipu Adhikari, a BCA student at Tribhuvan University and a passionate MERN Stack Developer.
